...
public class Usuario implements Serializable {
	...
	public Usuario(Long idPer, String nombreCompleto, String titulo, String descripcion, Set<Educacion> educaciones,
			Set<Experiencia> experiencias, Set<Proyectos> proyectos, Set<Skills> skills, Set<SoftSkills> softs) {
		super();
		this.idPer = idPer;
	...
	public Usuario(String nombreCompleto, String titulo, String descripcion) {
		super();
		this.nombreCompleto = nombreCompleto;
		this.titulo = titulo;
		this.descripcion = descripcion;
